...
4. Exit the container and enter again, but this time use the bind (-B) option to mount the directory you have created to "/dummy" inside the container. You can use pwd to know your current directory.
...
<details>
  ...
  cd /dummy
  exit
  singularity shell -C -B /home/user/dummy:/dummy lolcow.sif
  cd /dummy
  touch test.txt
  ls
  exit
