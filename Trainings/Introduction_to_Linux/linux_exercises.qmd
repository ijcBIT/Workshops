...
In your home directory create a new directory called 'analysis'. Copy the file peaks.bed there. Create another directory called 'test'. There, create a softlink to peaks.bed located in the shared folder and call the file 'test.bed'. 

Finally, list now all files end with ‘bed’ in a single command. What command did you use? 
...
# create dir
 mkdir analysis                     # create 'analysis' directory,
 cd analysis                        # enter 'analysis' directory
 cp /home/shared/peaks.bed .        # copy 'peaks.bed' there  
...
# create dir
 ...
 cd test                                    # enter 'analysis' directory
 ln -s /home/shared/peaks.bed -n test.bed   # create softlink 
