...
I am a bioinformatics technician currently working at [(IJC) Josep Carreras Leukaemia Research Institute]((https://www.carrerasresearch.org/es/)) in Badalona.
...
m <- leaflet() %>%
  ...
  addMarkers(lng=2.239724437547112, lat=41.48540089172277, popup="IJC BIT Headquarters")
m  # Print the map
```

You can check out our Unit webpage here: [And Bioinformatics Unit (BIT) where I currently work here](https://www.carrerasresearch.org/es/unidad-de-bioinform%C3%A1tica_130420)
